    ...
    <div className="pb-4 md:px-24 md:mt-12 md:pb-10 relative">
      ...
      <div className="flex flex-col gap-12 md:gap-24">
        <HomeContent
          ...
          content={
            <>
              ...
              meningkatkan kreativitasmu? Dunia AI sekarang menyediakan berbagai
              alat canggih yang bisa membantu membuat karya lebih cepat, lebih
              efektif, dan lebih menarik. Yuk, mulai eksplorasi AI untuk
        ...
        <HomeContent
          ...
          content={
            <>
              ...
              kamu belum mencoba, sekarang adalah waktu yang tepat untuk memulai
              dan melihat dampaknya pada produktivitasmu.
            </>
          }
        ...
        <HomeContent
          ...
          content={
            <>
              Mari bergabung dengan komunitas kreator yang menggunakan AI untuk
              menciptakan karya luar biasa. Di sini, kita bisa berbagi tips,
              trik, dan rekomendasi AI terbaik yang bisa membantu mengoptimalkan
              proses kreatifmu. Dengan saling berbagi, kita bisa berkembang
              bersama!
            </>
          }
