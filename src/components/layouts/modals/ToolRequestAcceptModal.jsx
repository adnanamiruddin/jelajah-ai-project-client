...
export default function ToolRequestAcceptModal({
  ...
  const handleAcceptToolRequest = async () => {
    ...
    if (error) {
      toast.error("Gagal menerima permintaan rekomendasi AI!");
      setLoading(false);
    }
  };

  return (
    <dialog id="tool_request_accept_modal" className="modal">
      <div className="modal-box bg-[#19161C] w-11/12 max-w-3xl rounded-lg border border-white">
        ...
        <div className="mt-6">
          <p className="text-lg">
            Apakah Anda yakin ingin menerima permintaan rekomendasi AI dari{" "}
